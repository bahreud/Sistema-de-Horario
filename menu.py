...
while True:
    ...
    op = input("\nEscolha uma opção: ") # o usuário escolhe o que quer fazer

    if op == "1": # ele escolhe quais dias são melhores para ele
        ...
        # dicionário que relaciona os números com tal dia
        dias_semana = {
            "1": "Segunda",
            "2": "Terça",
            "3": "Quarta",
        ...
        # dicionário que relaciona os horarios com tal número
        horas_dia = {
            "1": "7:10 às 8:00",
            "2": "8:00 às 8:50",
            "3": "8:50 às 9:40",
        ...
        try:
            dados = user.professores[user.matricula] # relaciona os professores com suas matrículas

            #dá ao usuário todos os dados do professor específico(que corresponde a tal matrícula
            print("\n---- DADOS DO PROFESSOR ----")
